                                ...
                                foreach ($products as $product) { ?>
                                    <tr class="text-sm md:text-xl">
                                        ...
                                        <td class="p-0">
                                            ...
                                            <a href="..\controller\approve_delete.php?p=<?= $product['p_id'] ?>" class="btn btn-sm btn-error text-xs font-thin text-white mb-2 md:hidden <?= $product['status'] === "กำลังยืม" ?  "btn-disabled" : "" ?>">นำออก</a>
                                        </td>
                                        <td class="hidden md:table-cell"><a href="..\controller\approve_delete.php?p=<?= $product['p_id'] ?>" class="btn btn-error text-white <?= $product['status'] === "กำลังยืม" ?  "btn-disabled" : "" ?>"><i class='bx bxs-trash bx-sm'></i></a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
